    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form  method="POST" action="<?php echo e(route('register_rapport')); ?>" class="theme-form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Project\laravel+Tessaract\github\isset\resources\views/rapport/create.blade.php ENDPATH**/ ?>