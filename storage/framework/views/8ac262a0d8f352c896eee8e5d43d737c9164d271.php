                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" class="form-select js-example-basic-single col-sm-12">
                                ...
                                <option <?php if($list_user->role == "Gerant"): ?> selected <?php endif; ?> value="Gerant">Agent</option>
                                <option <?php if($list_user->role == "Directeur"): ?> selected <?php endif; ?> value="Directeur">Chef de service</option>
                            </select>
                        </div>
                        <div class="form-group">
...
<?php /**PATH D:\Project\laravel+Tessaract\github\isset\resources\views/user/details.blade.php ENDPATH**/ ?>