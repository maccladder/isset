    ...
    <body>
      ...
      <div class="container">
          <div class="row justify-content-center">
              <div class="col-md-8">
                  <div class="card">
                      <div class="card-header"><?php echo e(__('Optical Character Recognition | Image annotation')); ?></div>
                      ...
                      <div class="card-body">
                          <form role="form" method="POST" action="/annotate" enctype="multipart/form-data">
                              ...
                              <div class="form-group row">
                                  <label for="email" class="col-sm-4 col-form-label text-md-right"><?php echo e(__('Upload image')); ?></label>
...
<?php /**PATH C:\wamp64\www\Projet-Isset\isset\resources\views/annotate.blade.php ENDPATH**/ ?>